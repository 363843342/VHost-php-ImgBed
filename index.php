...
/**
 * 身份校验 (支持 API 传参)
 * 默认密码123，它的sha265是a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3
 * 修改密码直接修改这后面的参数$safe_key =''
 * 需要使用sha265把密码明文转成密文，粘贴密文在参数当中。可以使用sha265在线加密工具
 */
